...
For this, we employed a similar approach to \citep{deng_distribution_2021}, 
...
recent solution that used a single population and constant Ne, instead 
...
through exhaustive simulations (e.g., \citep{mckenzie_multispecies_2020}.
...
lineage sorting, the multispecies coalescent model has facilitated the widespread 
use of multilocus data for phylogenetic inference. As phylogenetic systematics 
continues to turn toward whole genomes, methods should seek to take advantage 
...
per locus. Therefore, not accounting for recombination might mislead analyses. 
Conversely, incorporating the rates of turnover observed in the data as 
information could offer further clues for inference of the species tree 
