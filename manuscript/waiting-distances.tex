...
over which they extract information from genomes, typically either acting across 
...
%However, SMC'-based methods remain highly limited 
%with regard to the scale over which they extract information from genomes --
...
topology-changes) focus on "thinning" recombination events to model the sequential events
that extend over great spatial genomic distances and are detectable in the sequence 
data, while including all coalescences simultaneously. 
...
full coalescent with recombination or the SMC' approximation 
\citep{hudson1983properties,wiuf_recombination_1999,mcvean2005approximating}. Within the MS-SCM'
