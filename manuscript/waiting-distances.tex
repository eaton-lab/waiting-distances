...
Many extensions of the MS-SMC' are possible. One approach could be to isolate a clade
from a given genealogy and to estimate estimate the expected distance over which 
monophyly is expected to persist for this clade under neutrality. 
%%^this is for.... locus sizes for clade-level inference, introgression, etc
...
Waiting distances between topology changes in genomic regions derived from one network history 
