...
% We examined results across a range of parameter settings for a fixed 
% diploid effective population size applied to all lineages in a model. 
% When N$_e$ is low, 
...
The exponential rate parameter for the probability density of waiting distances 
...
% Waiting distances to tree and topo change
The exact solutions for the probabilities of different recombination
event type outcomes, and for the waiting distance until a tree-change 
event, appear to converge on the mean outcomes from stochastic 
coalescent simulations. The degree of matching between our analytical 
