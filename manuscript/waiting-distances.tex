...
which is an approximation), unless specified, and using the argument 
"record\_full\_arg=True", to keep a record of invisible recombination events. 
...
For each value of Ne, 10K tree sequences were simulated. Given each starting tree,
...
% Probabilities of tree and topo-change
...
Waiting distance to tree or topology changes te=nd to be shorter for
