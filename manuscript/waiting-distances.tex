...
While possible across single, short segments, this is not a tractable solution across long 
sequences of genealogies or across many replicates. 
...
topology changes \hl{(e.g. Fig.~\ref{fig:fig-validation}) --- actually this might not be a good example of 
\emph{spatial} variance in the \emph{expected} waiting distances}. 
