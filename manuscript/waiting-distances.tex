...
\hl{These can be grouped more generally into three types: 
...
\hl{Within our framework, MSC model parameters determine probabilities of coalescence}
...
including short aligned contigs, \hl{or genes,} and \hl{more recent methods can} 
...
direction. One further approach may be to build upon the framework of the species
...
A theoretical ARG-based extension of this approach might similarly 
analyze many linked SNPs and bypass ARG inference by integrating over a 
