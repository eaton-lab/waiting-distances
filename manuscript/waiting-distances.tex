...
\begin{figure}
	...
	\includegraphics[width=0.99\textwidth]{figures/Fig3-parameters-extend-PFM1.pdf}
	\caption{A gene tree embedded in a species tree. 
	(a) Species tree divergence times ($W$) define ancestral populations. The population 
	...
	subset of the events in (c). See Table 1 for the full gene tree embedding table for this 
	example.
	}
	\label{fig:fig1}
\end{figure}
