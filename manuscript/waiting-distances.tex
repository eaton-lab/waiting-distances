...
Our results show that waiting distances between topology changes can 
exhibit high variance even in neutral scenarios depending on demographic 
model parameters. 
MS-SMC' based waiting distance expectations can provide a 
null model for a more robust evolutionary hypothesis testing framework
that takes into account the demographic history of populations.
