...
in any arbitrarily parameterized structured 
\textcolor{red}{demographic \sout{coalescent}} model. 
% 
\textcolor{red}{
...
Our 
\textcolor{red}{multi-species sequentially Markov coalescent (MS-SMC)
model is
\sout{MS-SMC approach provides}
}
a predictive model for the relationship between 
...
the effect of MSC model parameters on the probability of genealogical turnover
can be computed and visualized for a single genealogy
...
the likelihood of an observed waiting distance spanned by a genealogy
as a function of the genealogy and species tree.
\sout{
...
The process of fitting MSC model parameters to a distribution of genealogies
(or molecular sequences modeled as evolving on genealogies) was first
developed over 20 years (CITE) and has become a fundamental method in 
evolutionary genomics (CITE REVIEW). 
% 
Here, we demonstrated that the parameters of a species tree model can be
estimated from a completely new source of information, in the form of the
interval distance spanned by genealogies between recombination events causing
a tree-change or topology-change. 
% 
Tree and topology distances exhibited distinctly different sources of 
information, and could be combined.
% 
We examined likelihood surfaces, and implemented a Bayesian inference framework
to obtain the joint posterior distribution. 
% 
The likelihood of coalescent times in genealogies is greater than the likelihood
of waiting distances spanned by tree .. topo events.




\subsection{Applications and Extensions of the MS-SMC}
