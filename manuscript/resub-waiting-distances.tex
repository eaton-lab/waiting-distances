...
\begin{figure}[t]
	...
	\includegraphics[width=0.99\textwidth]{figures/Fig2-recomb-types-ARG-newalt2.pdf}
	\caption{
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.99\textwidth]{figures/FigX-embedding-table2.pdf}
	\caption{
...
\begin{figure}[t]
	...
	\caption{
		...
		%, or $\mathcal{J}_b(i)$. 
		(b) Indexing variables for calculating \st{tree}\textcolor{red}{no}-change probabilities. The indexing 
...
\begin{figure}
	\centering
	\includegraphics[width=0.99\textwidth]{figures/Fig1-embedding-and-probs-fill-newalt-4.pdf}
	\caption{
...
C and D (Fig.~\ref{fig:edge-probabilities}a; Fig.~\ref{fig:figS-edge-probabilities}). 
...
\st{probability of a} tree-change \textcolor{red}{events}; 
...
\subsection{\textcolor{red}{Calculating the likelihood of an ARG under the MS-SMC}}
 % \st{MS-SMC likelihood inference framework}}
