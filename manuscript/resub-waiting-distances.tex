...
regions. 
\st{Expectations for the amount of g}\textcolor{red}{G}enealogical 
variation among unlinked 
...
Importantly, 
\st{both the coalescent and MSC are models of the expected distribution of 
...
occurs at some predictable rate (or rate map) from which the \st{expected} 
...
This greatly reduces the space of possible ARGs without changing the \st{expected}
